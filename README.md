...
1.	Aggregate operations: Java uses Streams (1.8) to query in-memory objects.
2.	Foreach construct
3.	Iterators – calling collection’s iterator method (ie: .next(), .hasNext()); Java uses Iterable/Iterator interface.
